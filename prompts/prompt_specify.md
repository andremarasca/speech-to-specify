...
Este é o primeiro estágio de um processo multifásico. O conteúdo de entrada será reutilizado posteriormente para plano técnico e tarefas de implementação. Portanto, esta etapa existe exclusivamente para definir visão, intenção e valor.
